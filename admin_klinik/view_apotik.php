...
<tr><td align="center"><?php echo $count; ?></td>
	...
	<td align="center"><a href="edit_apotik.php?id_apotik=<?php echo $row["id_apotik"]; ?>">Edit</a></td>
	<td align="center"><a href="delete_apotik.php?id_apotik=<?php echo $row["id_apotik"]; ?>">Delete</a></td>
</tr>
<?php $count++; } ?>
</tbody>
</table>
